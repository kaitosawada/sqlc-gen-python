...
class Querier:
    ...
    def create_author(self, *, name: str, bio: Optional[str]) -> None:
        self._conn.execute(sqlalchemy.text(CREATE_AUTHOR), {"p1": name, "p2": bio})
...
class AsyncQuerier:
    ...
    async def create_author(self, *, name: str, bio: Optional[str]) -> None:
        await self._conn.execute(sqlalchemy.text(CREATE_AUTHOR), {"p1": name, "p2": bio})
